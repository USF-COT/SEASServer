...
%token SET READ CALC RECORD WRITE SPECPARAMS ABSPARAMS NONABSPARAMS REF SAMPLE ABSCOR FULLSPEC CONC TOTC PCO2 PH STANDARDS DATAFILE DELAY BEGIN END LOOP BEEP 
